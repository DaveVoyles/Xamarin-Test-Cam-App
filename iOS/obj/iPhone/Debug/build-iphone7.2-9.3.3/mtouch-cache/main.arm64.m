...
extern void *mono_aot_module_testcamapp_iOS_info;
...
{
	mono_aot_register_module (mono_aot_module_testcamapp_iOS_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("Plugin.Media.dll");
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "testcamapp.iOS.exe";
